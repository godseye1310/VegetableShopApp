...
function handleAddVegtoShop(event) {
	...
	axios
		.post("https://crudcrud.com/api/dd627d9e4da944889e0b79a56b4519d7/vegShopData", veggiesData)
		.then((response) => {
...
window.addEventListener("DOMContentLoaded", () => {
	axios
		.get("https://crudcrud.com/api/dd627d9e4da944889e0b79a56b4519d7/vegShopData")
		.then((response) => {
...
function displayVeggiesList(vegObj) {
	...
	buybtn.addEventListener("click", () => {
		...
		vegDataDiv.innerHTML = `${vegObj.theVegName}    <strong>₹</strong>${vegObj.theVegPrice}  ${vegObj.theVegQty - buyVal.value}  <strong>KG</strong>`;

		let buyqty = vegObj.theVegQty - buyVal.value;
		vegObj.theVegQty = buyqty;

		axios
			.put("https://crudcrud.com/api/dd627d9e4da944889e0b79a56b4519d7/vegShopData/" + vegObj._id, {
	...
	deletebtn.addEventListener("click", () => {
		...
		axios
			.delete("https://crudcrud.com/api/dd627d9e4da944889e0b79a56b4519d7/vegShopData/" + vegObj._id)
			.then((response) => console.log(response.status))
			.catch((error) => console.log(error));
	});
