...
function handleAddVegtoShop(event) {
  ...
  axios
    .post(
      "https://crudcrud.com/api/dd627d9e4da944889e0b79a56b4519d7/vegShopData",
      veggiesData
    )
    .then((response) => {
...
function displayVeggiesList(vegObj) {
  ...
  buybtn.addEventListener("click", () => {
    ...
    vegDataDiv.innerHTML = `${vegObj.theVegName}    <strong>₹</strong>${
      vegObj.theVegPrice
    }  ${vegObj.theVegQty - buyVal.value}  <strong>KG</strong>`;
